...
#define TPWM_us				(uint32_t) 9999 //PWM 周期(us)

uint16_t capture = 0;
uint16_t TIM1CCR3_Val    = 500;    //M X 20000
//PWM M-X
uint16_t T3CCR1_Val      = CyclePWM>>1;
uint16_t T3CCR2_Val      = CyclePWM>>1;
uint16_t T3CCR3_Val      = CyclePWM>>1;
uint16_t T3CCR4_Val      = CyclePWM>>1;
